...
- [10. Git 风格指南](./Git-风格指南.md)

- [11. 经验套路](./经验套路.md#11-经验套路)

  - [11.1 缓存更新的套路](./经验套路.md#111-缓存更新的套路)

  - [11.2 XY问题](./经验套路.md#112-xy问题)

  - [11.3 如何问问题](./经验套路.md#113-如何问问题)

  - [11.4 单元测试](./经验套路.md#114-单元测试)

  - [11.5 贫血模型的传统开发模式](./经验套路.md#115-贫血模型的传统开发模式)

  - [11.6 充血模型的 DDD 开发模式](./经验套路.md#116-充血模型的-ddd-开发模式)

  - [11.7 IoC容器和Dependency Injection模式](./经验套路.md#117-ioc容器和dependency-injection模式)

  - [11.8 设计模式二三事](./经验套路.md#118-设计模式二三事)

  - [11.9 设计模式在外卖营销业务中的实践](./经验套路.md#119-设计模式在外卖营销业务中的实践)

- [12. Java基础知识](./Java基础知识.md#12-Java基础知识)

- [13. 数据库基础知识](./数据库基础知识.md/#13-数据库基础知识)

  - [13.1 第三范式](./数据库基础知识.md/#131-第三范式)

  - [13.2 MySQL](./数据库基础知识.md/#132-mysql)

    - [13.2.1 图解SQL的JOIN](./数据库基础知识.md/#1321-图解sql的join)
